...
public class Engine {
    ...
    public void openp() {
    	if(open)displayString= "Error: Too many open parenthensis!";
    	else {open =true; displayString+="{";}
    	
    }

    public void closep() {
    	if(!open)displayString= "Error: Too many closing paranthensis!";
    	else { open = false; displayString += "}";}
    ...
    public void numberPressed(int number) {
       ...
       if(setMode) {
    	   if(!operator) {
    		   if(leftSet.isMember(number)) displayString = "Error: Number already in set";
    		   leftSet.add(number);
    	   }
    	   else  {
    		   if(rightSet.isMember(number)) displayString = "Error: Number already in set";
    		   rightSet.add(number);
    	   }
