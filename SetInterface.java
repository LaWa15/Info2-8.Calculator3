...
public class SetInterface extends HexInterface implements ActionListener {
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (command.equals("{")) calc.openp();
		if (command.equals("}")) calc.closep();
		if (command.equals(", ")) calc.comma();
		if (command.equals("length")) calc.getLength();
		if (command.equals("intersec")) calc.op(command);
